                ...
                for id, detection in enumerate(self.results.detections):
                  ...
                  # print(detection.location_data.relative_bounding_box)
                    ...
                    if draw :
                        ...
                        # cv2.rectangle(img, bbox, (225, 0, 0), 2)
                        cv2.putText(img, f'{int(detection.score[0] * 100)}%', (bbox[0], bbox[1] - 20), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
        return img, bboxs

    def fancyDraw(self,img,bbox, l = 40, t=3, rt =1):
        x,y,w,h = bbox
        x1, y1, = x + w, y + h
